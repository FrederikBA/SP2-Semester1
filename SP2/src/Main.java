...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\n" + "Samlet pris: " + garage.calculateGreenTaxForParkedCars());

        //   Objects instantiated for testing purposes.

        //   GasolineCar gasolinecar = new GasolineCar("123","Audi","A8",2020,4,25,9);
